...
<p>
    <ul>
        ...
        <li><b>Comments</b> - List of all coments the user has made under your videos.</li>
        <li><b>Friends</b> - Shows this icon 🫂 if the user is in your friend list</li>
        <li><b>Followers</b> - Shows this icon ☑️ if the user is following you and a date, which shows since when is he following you</li>
    </ul>
</p>
